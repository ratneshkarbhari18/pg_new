    ...
    <section id="about-text" style="margin: 2em 0;">
        ...
        <div class="row" style="margin: 3% 0;">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 text-justify">
                <!-- <h3 class="simple-title text-center" style="font-size: 30px;">About Us</h3> -->
                <div data-aos-duration="2000" data-aos="fade-right" id="about-text" class="aos-init aos-animate">
